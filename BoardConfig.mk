...
ifdef KLTE_MARSHMALLOW
	TARGET_PREBUILT_KERNEL := device/samsung/klteduos/zImage-M
	TARGET_PREBUILT_DTB := device/samsung/klteduos/dtb.img-M
else
	TARGET_PREBUILT_KERNEL := device/samsung/klteduos/zImage-L
	TARGET_PREBUILT_DTB := device/samsung/klteduos/dtb.img-L
endif
